...
internal static class Observation
{
    ...
    {
        using var map=MemoryMappedFile.OpenExisting($"Local\\StoneshardCompanion.v5.{session.Pid}",MemoryMappedFileRights.Read);
