...
internal static class Observation
{
    ...
    {
        using var map=MemoryMappedFile.OpenExisting($"Local\\StoneshardCompanion.v7.{session.Pid}",MemoryMappedFileRights.Read);
