...
public sealed class SettingsWindow : Window
{
    ...
    public SettingsWindow(MainWindow owner)
    {
        ...
        Adjust("属性面板宽度",250,1800,owner.Preferences.StatsWidth,v=>owner.Preferences.StatsWidth=v," px");
        Adjust("属性面板高度",200,1400,owner.Preferences.StatsHeight,v=>owner.Preferences.StatsHeight=v," px");
        ...
        Adjust("装备耐久预警线",0,100,owner.Preferences.DurabilityWarning,v=>owner.Preferences.DurabilityWarning=v,"%");
